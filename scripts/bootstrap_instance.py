...
def reset_runtime(repository: str, project_name: str, owner: str, security_capability: str) -> dict[str, str]:
    ...
    protected = [
        ...
        "/SECURITY.md", "/CONTROL-PLANE-SECURITY.md", "/PRODUCTION-ASSURANCE.md", "/DESIGN-DATA-OPERATIONS.md", "/AI-NATIVE-PRODUCT-ASSURANCE.md",
        "/config/ai/agent-catalog.json", "/config/ai/memory-provenance.json", "/config/ai/ai-evaluation-policy.json", "/config/coordination/", "/config/protocol/",
        "/config/security/", "/config/consent/", "/config/github/", "/config/quality/", "/config/runtime/", "/config/release/",
        "/config/data/", "/config/product/", "/config/assurance/", "/config/research/", "/config/operations/", "/config/contracts/", "/config/integrations/", "/config/design/", "/config/testing/",
