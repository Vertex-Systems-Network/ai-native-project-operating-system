...
def reset_runtime(repository: str, project_name: str, owner: str, linear_id: str | None, linear_url: str | None) -> dict[str, str]:
    timestamp = now()
...
def main() -> int:
    ...
    changes = reset_runtime(repository, project_name, preview_owner, args.linear_project_id, args.linear_project_url)
