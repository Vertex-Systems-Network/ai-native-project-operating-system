...
Commercial service **0.4.6** retains conditional premium delivery plumbing and attests the ANPOS 1.4.0 protocol identity while leaving Developer-only operation independent from premium configuration.
...
- entitlement-gated immutable premium distribution source: **implemented in commercial service 0.4.6**;
