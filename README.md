...
This is the **Repository Supervisor source runtime + full planner + sandbox-backed full apply + guarded empty bootstrap + production E2E harness**, not evidence that the sandbox gateway or public plugin is deployed or that live GitHub read/write E2E has passed. Explicit conflict-resolution apply, live sandbox/E2E receipts and GitLab parity remain subsequent milestones.
