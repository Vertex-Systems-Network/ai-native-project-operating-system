...
class RepositorySupervisorProductionRuntimeTests(unittest.TestCase):
    ...
    def test_commercial_role_routes_sandbox_and_e2e_assets(self) -> None:
        ...
        for path in [
            ...
            "commercial-service/migrations/009_external_billing_provider.sql",
            "commercial-service/lib/paddle.ts",
            "commercial-service/app/api/webhooks/paddle/route.ts",
            "commercial-service/app/api/v1/billing/checkout/route.ts",
