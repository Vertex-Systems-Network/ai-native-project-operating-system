...
The server must return the evidence used for classification, including repository identity, default branch, current head SHA, and ANPOS fingerprint files that were checked.
...
12. open a PR/MR with the complete adoption report.
